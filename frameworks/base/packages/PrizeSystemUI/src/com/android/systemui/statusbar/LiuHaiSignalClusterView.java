...
public class LiuHaiSignalClusterView
    ...
    private class PhoneState {
        ...
        private void setNetworkIcon() {
            ...
            if (mNetworkIcon == 0) {
                ...
                //pss add for always 4G-20180710-start
                boolean is4gGray = false;
                //pss add for always 4G-20180710-end
                ...
                //pss add for always 4G-20180710-start
                if(android.os.SystemProperties.get("ro.prize_always_4g").equals("1") && !is4gGray){
                    icon = R.drawable.stat_sys_network_type_4g;
                    //add by zhangrui start
			        boolean enable1 = android.os.SystemProperties.getInt("ro.prize.4g5g", 0) == 1 ? true : false;
			        int defIsOn = android.os.SystemProperties.getInt("ro.prize.de4g5g", 0);
			        if(enable1){
				        if(Settings.System.getInt(getContext().getContentResolver(),"def_prize_4g_to_5g", defIsOn) == 1){
				            icon = R.drawable.stat_sys_network_type_5g;
				        }
			        }
		            //add by zhangrui end
                } else {
    ...
    public int exchangeGrayIcon(int iconid){
        int result = iconid;
        //pss add for always 4G-20180710-start
        if(android.os.SystemProperties.get("ro.prize_always_4g").equals("1")){
			...
			if(enable1){
				if(Settings.System.getInt(getContext().getContentResolver(),"def_prize_4g_to_5g", defIsOn) == 1){
				    result = R.drawable.stat_sys_network_type_5g_gray_prize;
				}
			}
		    //add by zhangrui end
            return result;
        ...
        //add by zhangrui start
		boolean enable = android.os.SystemProperties.getInt("ro.prize.4g5g", 0) == 1 ? true : false;
		int defIsOn1 = android.os.SystemProperties.getInt("ro.prize.de4g5g", 0);
		if(enable){
			if(Settings.System.getInt(getContext().getContentResolver(),"def_prize_4g_to_5g", defIsOn1) == 1){
			    result = R.drawable.stat_sys_network_type_5g_gray_prize;
			}
		}
		//add by zhangrui end
    ...
    public int exchangeIconForLiuHai(int iconid, int statusBarStyle){
        ...
        if(android.os.SystemProperties.get("ro.prize_always_4g").equals("1")){
            if(isNeedGrayIcon){
                result = R.drawable.liuhai_stat_sys_network_type_4g_gray_prize;
            } else {
                result = R.drawable.liuhai_stat_sys_network_type_4g;
            }
			//add by zhangrui start
			boolean enable1 = android.os.SystemProperties.getInt("ro.prize.4g5g", 0) == 1 ? true : false;
			int defIsOn = android.os.SystemProperties.getInt("ro.prize.de4g5g", 0);
			if(enable1){
				if(Settings.System.getInt(getContext().getContentResolver(),"def_prize_4g_to_5g", defIsOn) == 1){
					if(isNeedGrayIcon){
						result = R.drawable.liuhai_stat_sys_network_type_5g_gray_prize;
					} else {
						result = R.drawable.liuhai_stat_sys_network_type_5g;
					}
				}
			}
		//add by zhangrui end
